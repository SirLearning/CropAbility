...
Timing utilities
================
Provides the Timer context manager and timeit decorator, with CUDA event timing when available.
"""
...
class Timer:
    """High-precision timer; uses CUDA events when a GPU is available.
